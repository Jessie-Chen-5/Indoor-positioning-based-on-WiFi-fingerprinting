...
class SVM():
	def __init__(self):
		self.longitude_regressor = svm.SVR()
		self.latitude_regressor = svm.SVR()
		self.floor_classifier = svm.SVC()
		self.building_classifier = svm.SVC()
